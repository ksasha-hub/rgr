                ...
                case CiphAction::ENCRYPT: {
                    ...
                    switch (inChoice) {
                        case InCiph::CONSOLE_INPUT: {
                            ...
                            string ciphtext = polybiusEncryptText(text, true);
                        ...
                        case InCiph::FILE_INPUT: {
                            ...
                            polybiusEncryptFile(inputFile, outputFile);
                ...
                case CiphAction::DECRYPT: {
                    ...
                    switch (decryptSource) {
                        case InCiph::CONSOLE_INPUT: {
                            ...
                            string result = polybiusDecryptText(ciphtext, true);
                        ...
                        case InCiph::FILE_INPUT: {
                            ...
                            polybiusDecryptFile(inputFile, outputFile);
